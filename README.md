...
Linux 서버 운영과 인프라 학습 과정에서 직접 수행한 구축·설정·검증·장애 분석 기록입니다.

## 주요 실습

- [BIND9 재귀·캐싱 DNS 및 Primary 권한 DNS 구축](./04-Labs/01-리눅스/08%20BIND9%20재귀·캐싱%20DNS%20및%20Primary%20권한%20DNS%20구축.md.md)
